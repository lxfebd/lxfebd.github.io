              ...
              >
                ...
                <div className="flex items-start justify-between mb-4 relative z-10">
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 w-10 h-10 flex items-center justify-center rounded-lg border border-indigo-500/20">{project.icon}</span>
